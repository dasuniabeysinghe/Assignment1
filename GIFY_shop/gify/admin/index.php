...
// Function to get proper image path for display
function getImagePath($image_url) {
    ...
    // If it's just a filename without path, prepend the image directory
    if (strpos($image_url, '/') === false && strpos($image_url, 'image/') === false) {
        return '../image/' . $image_url;
    }
    // If it already has image/ prefix but from root perspective
